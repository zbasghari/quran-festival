...
// در فایل js/quran.js بعد از sampleAyat موجود، این کد را اضافه کنید:

// توسعه sampleAyat برای سوره‌های بیشتر
const additionalSampleAyat = {
    // سوره البقره
    2: [
        {
            number: 1,
        ...
        {
            number: 2,
            text: "ذَٰلِكَ الْكِتَابُ لَا رَيْبَ ۛ فِيهِ ۛ هُدًى لِّلْمُتَّقِينَ ﴿٢﴾",
            translation: "این کتاب است که شکی در آن نیست، راهنمای پرهیزگاران است"
        },
        {
            number: 3,
            text: "الَّذِينَ يُؤْمِنُونَ بِالْغَيْبِ وَيُقِيمُونَ الصَّلَاةَ وَمِمَّا رَزَقْنَاهُمْ يُنفِقُونَ ﴿٣﴾",
            translation: "کسانی که به غیب ایمان می‌آورند و نماز را بر پا می‌دارند و از آنچه به آنان روزی داده‌ایم انفاق می‌کنند"
        }
    ],
    ...
    3: [
        ...
        {
            number: 2,
            text: "اللَّهُ لَا إِلَٰهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ ﴿٢﴾",
            translation: "الله که معبودی جز او نیست، زنده و پاینده است"
        }
    ],
    ...
    36: [
        ...
        {
            number: 2,
            text: "وَالْقُرْآنِ الْحَكِيمِ ﴿٢﴾",
            translation: "سوگند به قرآن حکیم"
        },
        {
            number: 3,
            text: "إِنَّكَ لَمِنَ الْمُرْسَلِينَ ﴿٣﴾",
            translation: "که تو از فرستادگانی"
        }
    ],
    ...
    55: [
        ...
        {
            number: 2,
            text: "عَلَّمَ الْقُرْآنَ ﴿٢﴾",
            translation: "قرآن را آموخت"
        },
        {
            number: 3,
            text: "خَلَقَ الْإِنسَانَ ﴿٣﴾",
    ...
    56: [
        {
            number: 1,
            text: "إِذَا وَقَعَتِ الْوَاقِعَةُ ﴿١﴾",
            translation: "هنگامی که واقعه رخ دهد"
        },
        {
            number: 2,
            text: "لَيْسَ لِوَقْعَتِهَا كَاذِبَةٌ ﴿٢﴾",
            translation: "برای وقوع آن هیچ دروغی نیست"
        }
    ],
    ...
    67: [
        {
            number: 1,
            text: "تَبَارَكَ الَّذِي بِيَدِهِ الْمُلْكُ وَهُوَ عَلَىٰ كُلِّ شَيْءٍ قَدِيرٌ ﴿١﴾",
            translation: "پر برکت است کسی که فرمانروایی در دست اوست و او بر هر چیزی تواناست"
        },
        {
            number: 2,
            text: "الَّذِي خَلَقَ الْمَوْتَ وَالْحَيَاةَ لِيَبْلُوَكُمْ أَيُّكُمْ أَحْسَنُ عَمَلًا ﴿٢﴾",
            translation: "کسی که مرگ و زندگی را آفرید تا شما را بیازماید که کدامتان بهتر عمل می‌کنید"
        }
    ],
    ...
    108: [
        {
            number: 1,
            text: "إِنَّا أَعْطَيْنَاكَ الْكَوْثَرَ ﴿١﴾",
            translation: "ما به تو کوثر عطا کردیم"
        },
        {
            number: 2,
            text: "فَصَلِّ لِرَبِّكَ وَانْحَرْ ﴿٢﴾",
            translation: "پس برای پروردگارت نماز بخوان و قربانی کن"
        },
        {
            number: 3,
            text: "إِنَّ شَانِئَكَ هُوَ الْأَبْتَرُ ﴿٣﴾",
            translation: "به یقین دشمن تو، او بی‌دنباله‌تر است"
        }
    ]
};

// ادغام با sampleAyat موجود
Object.assign(sampleAyat, additionalSampleAyat);
